...
class StagaireRefusExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        return Stagaire::select('cin','nom','prenom','email','telephone','etablisement','dateDebut','dateFin','statut')->where('statut','refuse')->get();
    }
